            ...
            <div className="mt-6 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-neutral-200 bg-slate-50 px-3 py-2 text-xs font-semibold text-neutral-600 transition-colors hover:bg-slate-100 disabled:opacity-50 dark:border-white/10 dark:bg-white/5 dark:text-neutral-300 dark:hover:bg-white/10"
                >
