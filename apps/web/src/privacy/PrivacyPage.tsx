    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '3. 删除权：你可以在「账户设置」中选择「注销账号」，我们将删除你的全部个人数据（包括单词本、学习记录、AI 配置等）。',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '4. Service improvement: analyzing usage patterns to optimize product features and experience.',
